...
<task type="auto">
  <name>Task 2: Template form component and pages</name>
  <files>
    apps/dashboard/src/components/templates/template-form.tsx
    apps/dashboard/src/components/templates/script-editor.tsx
    apps/dashboard/src/components/templates/file-editor.tsx
...
3. **Create `src/components/templates/template-form.tsx`** ("use client"):
...
4. **Create `src/app/templates/new/page.tsx`** (Server Component):
...
5. **Create `src/app/templates/[id]/edit/page.tsx`** (Server Component):
   ...
   - Scripts can be added, removed, reordered by number
   - Files can be added and removed with path/policy/content
   - Package buckets can be selected from available list
